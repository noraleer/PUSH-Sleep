...
The three sleep environment variables are sleep disruptions, sleep quiet, and sleep dark. Notably, sleep dark is true for all indivduals except for one. Because only one person does not have a dark sleep environment, this variable cannot be used in the models.
...
#Model 1: Neighborhood Factors
################################
mod1_on_var <- lm(C_ACTI_SleepTime_sd ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + weekend + geo_COI_ED_3.0 + geo_COI_HE_3.0 + geo_COI_SE_3.0, data = weekly)
summary(mod1_on_var)
...
#Model 2: Family Factors
################################
mod2_on_var <- lm(C_ACTI_SleepTime_sd ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
summary(mod2_on_var)
...
#Model 3: Sleep Environment Characteristics
################################
mod3_on_var <- lm(C_ACTI_SleepTime_sd ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + weekend + c_se_12_v2 + c_se_8_v2, data = weekly)
summary(mod3_on_var)
