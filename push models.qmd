...
i.  None (only COI total in model 1)
ii. None
...
i.  None
ii. P_COHESION has a negative coefficient (-0.7401, CI: -1.458, -0.042)

<!-- -->

3.  Onset/Falling Asleep (Time from laying down to falling sleep) (C_ACTI_SOL)

-   log transformation for both models
...
4.  Onset/Falling Asleep (Fell Asleep Time) (C_ACTI_SleepOnsetTime_TRM)
...
i.  None
ii. C_MESA_FT has positive coefficient (1.0892, CI: 0.3695, 1.8128). C_MESA_ES has a negative coefficient (-2.555, CI: -4.937, -0.1739)

<!-- -->

6.  Duration Variability (C_ACTI_SleepTime_sd)

-   no log transformation

i.  None
ii. MESA_ES has positive coefficient (23.173, CI: 1.599, 44.747)

<!-- -->

7.  Offset Variability (C_ACTI_WT_DEC_sd) 

-   no log transformation (but could do it)

i.  geo_COI_3.0 has negative coefficient (-0.52009, CI: -0.9615, -0.07869)
ii. None



(C_ACTI_WakeTime (not using): C_MESA_ES has positive coefficient (11.39, CI: 6.074, 16.706). CHAOS has a negative coefficient (-11.972, CI: -20.200, -3.745).)

<!-- -->

8.  Onset Variability (C_ACTI_SleepOnsetTime_TRM_sd)

-   no log transformation (but could do it)

i.  None
ii. MESA_ES has positive coefficient (0.641, CI: 0.3089, 0.9721). 

### Changes 9/2

- take out model 3
- take out awakenings model
- take out daytype (school/summer) covariate in each model
- do coi total in model 1
- write up what actually exists
...
################################
mod1_duration <- lmer(C_ACTI_SleepTime ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0 + (1|ParticipantID), data = models)
...
#Model 1: Neighborhood Factors
################################
mod1_offset <- lmer(C_ACTI_WT_DEC ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0 + (1|ParticipantID), data = models)
summary(mod1_offset)
...
#Model 1: Neighborhood Factors
################################
mod1_onset1 <- lmer(C_ACTI_SOL ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0 + (1|ParticipantID), data = models)
summary(mod1_onset1)
...
# log
mod1_onset1_log <- lmer(log(C_ACTI_SOL + 1) ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0 + (1|ParticipantID), data = models)
...
#Model 1: Neighborhood Factors
################################
mod1_onset2 <- lmer(C_ACTI_SleepOnsetTime_TRM ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0 + (1|ParticipantID), data = models)
summary(mod1_onset2)
...
#Model 1: Neighborhood Factors
################################
mod1_efficiency <- lmer(C_ACTI_Efficiency ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0 + (1|ParticipantID), data = models)
...
# log
mod1_efficiency_log <- lmer(log(C_ACTI_Efficiency) ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0 + (1|ParticipantID), data = models)
...
#Model 1: Neighborhood Factors
################################
mod1_dur_var <- lm(C_ACTI_SleepTime_sd ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0, data = weekly)
...
# log
mod1_dur_var_log <- lm(log(C_ACTI_SleepTime_sd) ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0, data = weekly)
...
#Model 2: Family Factors
################################
mod2_dur_var <- lm(C_ACTI_SleepTime_sd ~ c_demo_8_v2 + c_demo_6_v2 + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
...
# log
mod2_dur_var_log <- lm(log(C_ACTI_SleepTime_sd) ~ c_demo_8_v2 + c_demo_6_v2 + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
...
### Offset Variability (C_ACTI_WT_DEC_sd)

```{r}
hist(all$C_ACTI_WT_DEC_sd)
summary(all$C_ACTI_WT_DEC_sd)

################################
#Model 1: Neighborhood Factors
################################
mod1_off_var <- lm(C_ACTI_WT_DEC_sd ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0, data = weekly)
...
# log
mod1_off_var_log <- lm(log(C_ACTI_WT_DEC_sd) ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0, data = weekly)
...
# log slightly better but close

################################
#Model 2: Family Factors
################################
mod2_off_var <- lm(C_ACTI_WT_DEC_sd ~ c_demo_8_v2 + c_demo_6_v2 + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
...
# log
mod2_off_var_log <- lm(log(C_ACTI_WT_DEC_sd) ~ c_demo_8_v2 + c_demo_6_v2 + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
...
mod2_off_var <- lm(C_ACTI_WakeTime_sd ~ c_demo_8_v2 + c_demo_6_v2 + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
summary(mod2_off_var)
ci <- confint(mod2_off_var)
print(ci)
...
### Onset Variability (C_ACTI_SleepOnsetTime_TRM_sd)

```{r}
hist(all$C_ACTI_SleepOnsetTime_TRM_sd)
summary(all$C_ACTI_SleepOnsetTime_TRM_sd)

################################
#Model 1: Neighborhood Factors
################################
mod1_on_var <- lm(C_ACTI_SleepOnsetTime_TRM_sd ~ c_demo_8_v2 + c_demo_6_v2 + weekend + geo_COI_3.0, data = weekly)
summary(mod1_on_var)
...
#Model 2: Family Factors
################################
mod2_on_var <- lm(C_ACTI_SleepOnsetTime_TRM_sd ~ c_demo_8_v2 + c_demo_6_v2 + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
summary(mod2_on_var)
...
# log 
mod2_on_var_log <- lm(log(C_ACTI_SleepOnsetTime_TRM_sd) ~ c_demo_8_v2 + c_demo_6_v2 + weekend + P_COHESION + C_MESA_FT + C_MESA_ES + C_CHAOS, data = weekly)
