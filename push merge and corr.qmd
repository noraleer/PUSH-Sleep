...
```{r}
vars <- all %>% select(C1_ACTI_SL_SleepTimeAvg, C1_ACTI_WTmean, C1_ACTI_SleepOnsetTime_mean, C1_ACTI_SL_EfficiencyAvg, C1_ACTI_SL_WasoAvg, C_ACTI_SleepTime_sd, C1_ACTI_SL_WakeTimeSd, C1_ACTI_SL_SleepTimeSd)
