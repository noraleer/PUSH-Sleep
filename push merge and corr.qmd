...
For the PUSH data, there is a wide dataset with all the survey information for the participants of the study. The long dataset has day-by-day data for metrics from each night of sleep for the participants. These datasets were merged into a single dataset. Then a correlation matrix was created for the variables of interest (dependent variables, covariates, and fixed effects). On the correlation matrix, darker colors and bigger squares mean a stronger correlation. The part of the matrix we are interested in is the top right part, which shows the correlation between the dependent variables and fixed effects.
