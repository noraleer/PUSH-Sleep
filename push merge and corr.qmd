...
#Model 1.1: COI Total
################################
mod1.1_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + geo_COI_3.0 + (1|ParticipantID), data = all)
...
#Model 1.2: COI Domains
################################
mod1.2_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + geo_COI_ED_3.0 + geo_COI_HE_3.0 + geo_COI_SE_3.0 + (1|ParticipantID), data = all)
...
#Model 2.1: Family Cohesion
################################
mod2.1_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + P_COHESION + (1|ParticipantID), data = all)
...
#Model 2.2: MESA
################################
mod2.2_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + C_MESA_FT + C_MESA_ES + (1|ParticipantID), data = all)
...
#Model 2.3: Adol CHAOS
################################
mod2.3_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + C_CHAOS + (1|ParticipantID), data = all)
...
#Model 3.1: Sleep Disruptions
################################
mod3.1_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + c_se_12_v2 + (1|ParticipantID), data = all)
...
#Model 3.2: Sleep Quiet
################################
mod3.2_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + c_se_8_v2 + (1|ParticipantID), data = all)
summary(mod3.2_duration)
...
#Model 3.3: Sleep Dark
################################
mod3.3_waketime <- lmer(sqrt(C_ACTI_WT_DEC) ~ c_demo_8_v2 + c_demo_6_v2 + C_DD_PM_DayType + c_se_11_v2 + (1|ParticipantID), data = all)
